...
(function () {
	...
	App.controller ("specialProcessCtrl", ["$scope", "angularFactory", function ($scope, angularFactory) {
		...
		win.moduleEntry.specialProcess = function (_supid) {
			service_supid = _supid;
			var firstContactDev = "0000";
			win.devService.sendDataToDev ("310961" + service_supid + firstContactDev);
		};

		win.devService.Fun710961 = function (varRecvData) {
